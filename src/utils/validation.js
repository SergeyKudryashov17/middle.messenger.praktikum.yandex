...
export function handleValidateField(fieldComponent) {
    const inputValue = fieldComponent.children.inputComponent.getContent().value;
...
export function checkPasswordMatch(fieldPassword, fieldPasswordRepeat) {
    let firstPassword = fieldPassword.children.inputComponent.getContent().value;
    let secondPassword = fieldPasswordRepeat.children.inputComponent.getContent().value;

    return firstPassword === secondPassword;
}

export function resetValidateField(fieldComponent) {
    const errorComponent = fieldComponent.children.errorTextComponent;
    errorComponent.setProps({
        className: '',
        text: ''
